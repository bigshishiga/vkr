...
python3 regiondrag/run_eval.py --data-dir "drag_data/dragbench-dr" --save-dir "{exp_name}" {add_args}
python3 regiondrag/run_eval.py --data-dir "drag_data/dragbench-sr" --save-dir "{exp_name}" {add_args}
"""
